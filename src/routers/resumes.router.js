...
import { createResumeValidator } from '../middlewares/validators.js/create-resume-validator.middleware.js';
import { updateResumeValidator } from '../middlewares/validators.js/update-resume-validator.middleware.js';
import { USER_ROLE } from '../constants/user.constant.js';
import { requireRoles } from '../middlewares/require-roles.middleware.js';
import { updateResumeStatusValidator } from '../middlewares/validators.js/update-resume-status-validator.middleware.js';
...
// 이력서 지원 상태 변경
resumesRouter.patch('/:id/status', requireRoles([USER_ROLE.RECRUITER]), updateResumeStatusValidator, async (req, res, next) => {
	try {
		const user = req.user;
